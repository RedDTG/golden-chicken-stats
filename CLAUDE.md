...
5. **Sheet append**: each parsed result becomes one row (`timestamp, player, result, gain, strength, message_id`) appended with `append_row(..., value_input_option="USER_ENTERED")`.
